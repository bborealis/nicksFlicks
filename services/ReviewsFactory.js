nicksFlicks.factory('ReviewsFactory', function ReviewsFactory() {
  ...
  factory.reviews = [{
    ...
    reviewText: "Princess Iron Fan (鐵扇公主, Tie shan gong zhu) is a 1966 Hong Kong film, the second in a series of four Shaw Brothers productions (1966–1968) based on the novel Journey to the West. It was directed by Ho Meng Hua.",
    selected: false
  }, {
    ...
    reviewText: "Have Sword, Will Travel is a 1969 Hong Kong wuxia film directed by Chang Cheh and starring Ti Lung, David Chiang and Lee Ching.",
    selected: false
  }, {
    title: "Blood Brothers",
    reviewText: "Blood Brothers (Traditional: 刺馬; Simplified: 刺马; Pinyin: Cì Mǎ) is a 1973 Shaw Brothers kung fu film directed by Chang Cheh, with action choreography by Lau Kar Leung, and starring David Chiang and Ti Lung. It was released as Chinese Vengeance in the UK and Australia, and Dynasty of Blood in North America. The films is a fictional story based on the assassination of Ma Xinyi.",
    selected: false
  }, {
    title: "Five Shaolin Masters",
    reviewText: "5 Shaolin Masters aka 5 Masters Of Death is a 1974 Shaw Brothers kung fu film directed by Chang Cheh, with action choreography by Lau Kar Leung and Lau Kar Wing. The film focuses on Shaolin's historic rivalries with the Qing Dynasty.",
    selected: false
  }];
  ...
  factory.unselectAll = function() {
    for (var i = 0; i < factory.reviews.length; i++) {
      if (factory.reviews[i].selected == true) {
        factory.reviews[i].selected = false;
      }
    }
  };
  return factory;
