nicksFlicks.factory('ReviewsFactory', function ReviewsFactory() {
  ...
  factory.reviews = [ { title:"Come Drink with Me", reviewText:"Come Drink with Me is a 1966 Hong Kong wuxia film directed by King Hu. Set during the Ming Dynasty, it stars Cheng Pei-pei and Yueh Hua as warriors with Chan Hung-lit as the villain, and features action choreography by Han Ying-chieh. It is widely considered one of the best Hong Kong films ever made." },
                      { title:"Princess Iron Fan", reviewText:"Princess Iron Fan (鐵扇公主, Tie shan gong zhu) is a 1966 Hong Kong film, the second in a series of four Shaw Brothers productions (1966–1968) based on the novel Journey to the West. It was directed by Ho Meng Hua." },
                      ...
                      { title:"Have Sword, Will Travel", reviewText:"Have Sword, Will Travel is a 1969 Hong Kong wuxia film directed by Chang Cheh and starring Ti Lung, David Chiang and Lee Ching." },
...
The films is a fictional story based on the assassination of Ma Xinyi." },
                      { title:"Five Shaolin Masters", reviewText:"5 Shaolin Masters aka 5 Masters Of Death is a 1974 Shaw Brothers kung fu film directed by Chang Cheh, with action choreography by Lau Kar Leung and Lau Kar Wing.
